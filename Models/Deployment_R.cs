...
namespace web_API9.Models
{
    public class Deployment_R
    {
        ...
        public Deployment_R(Deployment document, ProjectService ProjectService, DatabaseService DatabaseService, UserzService UserzService)
        {
            ...
            var _user = _UserzService.Get(document.SchemaCreatedByUserId);
